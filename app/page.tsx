...
function Home() {
  return (
    <MotionConfig reducedMotion="user">
      <div
        className="bg-[rgb(36,36,36)] text-whiteText h-screen snap-y snap-mandatory z-0 overflow-y-scroll overflow-x-hidden scrollbar-thin scrollbar-track-gray-400/20
