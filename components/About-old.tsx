...
export default function About({}: Props) {
  return (
    <motion.div
      ...
      <h3 className="absolute top-24 uppercase tracking-[15px] text-xl text-grey">
        About
      </h3>
      <motion.div
        initial={{
        ...
        md:rounded-md md:w-56 md:h-96 lg:w-[250px] lg:h-[375px]"
        >
        <Image   
...
{/* className="brightness-90 mb-5 md:mb-0 flex-shrink-0 w-36 h-36 rounded-full object-cover
        md:rounded-md md:w-56 mt-10 md:h-56 lg:w-[250px] lg:h-[375px]" */}
      <div className="px-7 mx-auto flex flex-col justify-center items-center">
        <h4 className="text-xl md:text-2xl text-whiteText font-semibold mb-7">Here is a <span className="underline decoration-yellow/40">little</span> background</h4>
