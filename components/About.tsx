...
export default function About({}: Props) {
  ...
  <div className="h-screen max-w-4xl mx-auto">
    <div className="flex flex-col justify-center items-center gap-3 md:gap-16">
      ...
      <motion.div 
        ...
        <div className='flex flex-col md:flex-row items-center md:gap-x-10'>
          ...
          <div className="mx-auto flex flex-col items-center md:items-start gap-y-5 px-10 md:px-0 " >
            <h4 className="text-xl md:text-2xl text-whiteText font-semibold">Here is a <span className="underline decoration-siteYellow/40">little</span> background</h4>
