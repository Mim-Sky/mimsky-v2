          ...
          <section className="flex flex-col md:flex-row items-center md:gap-x-10">
            ...
            <section className="mx-auto flex flex-col items-center md:items-start gap-y-5 px-10 md:px-0 ">
              ...
              <p className="text-whiteText ">
                ...
                styling of Tailwind CSS. Beyond code, an early fascination with
                electronics and IT during teenage years led me to tinker with
                hardware, constructing and managing my own computers—a hobby
                turned lifelong interest. On the software side, I&apos;m in a
                perpetual state of learning. The love for efficiency led me to
                the world of data containerization, where Docker becomes the
                playground for streamlined development and deployment. When not
                immersed in the virtual realm, there&apos;s joy in the tangible
                experience of constructing and building. Proudly assembling my
                own server from scratch, finding joy in mastering the art of
                server management. Join this journey where technology meets
                creativity, and every code line is a step toward innovation!
                🌐💻 #TechEnthusiast #CodeArtisan <br></br> During no-computer
                time, leveraging Iceland&apos;s incredible environment and
                opportunities. I&apos;m a rock and ice climber (with a glacier
