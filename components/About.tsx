      ...
      <motion.div 
        ...
        <div className='flex flex-col md:flex-row items-center md: gap-x-10'>
          ...
          <div className="mx-auto flex flex-col items-center md:items-start gap-y-5 px-10 md:px-0">
            ...
            Privatley I have a happy life on Iceland where I make use of enviroment and it`s opportunities. I am a rock and ice climber (with glacier guiding certificate), hiker and a cyclist. I actively take part in volounteer work (like `Hreinni Hornstrandir`). I also play piano and I am a big fan of english comedy series and their weird sense of humour!
            </p>
          </div>
        </div>
      </motion.div>
