...
function Projects({}: Props) {
  ...
  return (
    <div className="flex flex-col justify-center mx-auto">
      <h3 className="mt-24 uppercase tracking-[15px] text-grey text-xl mx-auto">
        Projects
      </h3>
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        <section className="relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-siteYellow/50">
