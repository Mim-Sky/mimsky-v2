...
export default function WorkExpirience({}: Props) {
  return (
    <div className="max-w-7xl mx-auto">
      <h3 className="mt-24 flex justify-center items-center uppercase tracking-[15px] text-base md:text-xl text-grey mb-24">
        Experience
      </h3>
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        <section
          className="w-full h-full flex space-x-5 overflow-x-scroll p-3 snap-x snap-mandatory scrollbar-thin scrollbar-track-gray-400/20
